...
int main(int argc, char *argv[])
{
  ...
  char tramVar[] = {0x00, 0x00, 0x00 ,0x01,0x00, // Fixed
                    ...
                    0x1E, // Mon Adresse Xway = 37
                    0x10, // Reseau et porte fixed to 01
                    0x0E, // Fixed
                    0x10, // Fixed
                    0x09, // 17 Task number -> Customizable
                    0x10, // Num porte -> Customizable
                    0x37, 0x10,0x06, 0x68, 0x07, 0x34, 0x00, 0x03, 0x00, 0x1E, 0x00, 0x07, 0x00, 0xFF, 0xFF // Request
  ...
  char anotherTram[] = {0x00, 0x00, 0x00 ,0x01,0x00, // Fixed
    ...
    0x00, // FIXED
    0xF1, // 5 way extension
    0x1E, // Mon Adresse Xway = 37 index [8]
    0x10, // Reseau et porte fixed to 01  
    0x0E, // Fixed
    0x10, // Fixed
    0x09, // 09 Task number
    ...
    0x1E, 0x00, // Valeur a écrire dans %MW10 par example. 37. Me!
    0x07, 0x00, // Valeur a écrire dans %MW11. 7 -> ID of troncon
    0xFF, 0xFF // Valeur a écrire dans %MW12. FF FF  -> FF FF in the aguillage.
};
  // char tramVar[] = {0x00, 0x00, 0x00, 0x01, 0x00, 0x15, 0x00, 0xF1, 0x1E, 0x10, 0x0E, 0x10,  0x37, 0x10,0x06, 0x68, 0x07, 0x34, 0x00, 0x03, 0x00, 0x1E, 0x00, 0x07, 0x00, 0xFF, 0xFF};

  // unsigned char tramResponse[] = {0x00, 0x00, 0x00, 0x01, 0x00, 0x12, 0x00, 0xF1, 0x1E, 0x10, 0x1E, 0x10, 0x37, 0x06, 0x68, 0x07, 0x34, 0x00, 0x03, 0x00, 0x1E, 0x00, 0x12, 0x00, 0x13, 0x00};
  ...
  char ackNowledge[] = {0x00, 0x00, 0x00, 0x01, 0x00, 0x09, 0x00, 0xF1, 0x1E, 0x10, 0x0E, 0x10, 0x19, 0x10, 0xFE};
